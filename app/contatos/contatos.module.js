...
ContatosModule = __decorate([
    core_1.NgModule({
        imports: [
            ...
            forms_1.FormsModule //declara modulos
        ],
        declarations: [
            contato_busca_component_1.ContatoBuscaComponent,
            contatos_lista_component_1.ContatosListaComponent,
            contato_detalhe_component_1.ContatoDetalheComponent //declara components
        ],
        providers: [
            contato_service_1.ContatoService //declara serviços
        ],
        exports: [
            contato_busca_component_1.ContatoBuscaComponent
        ]
